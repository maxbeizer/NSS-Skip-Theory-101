...
class ScalesMajorSharpsTest < Test::Unit::TestCase
  ...
  def test_01a_build_major_scale_from_start_position
    assert_equal "D" , example_scale2.build_major_scale[0]
  end

  def test_01b_build_major_scale_sharps
    assert_equal ["C", "D", "E", "F", "G", "A", "B"] , example_scale1.build_major_scale
  end

  def test_01c_build_major_scale_sharps
    assert_equal ["D", "E", "F#", "G", "A", "B", "C#"] , example_scale2.build_major_scale
  end

  def test_01d_build_major_scale_sharps_bmaj
    assert_equal ["B", "C#", "D#", "E", "F#", "G#", "A#"] , example_scale4.build_major_scale
  end
